...
model_path = os.path.join(current_dir, 'models', 'best_random_forest.joblib')
...
if st.button("Predict"):
    ...
    st.info("The prediction is based on the trained Random Forest model with 94% accuracy.")
